        ...
        <div className="min-h-screen bg-white dark:bg-[#0b1220] pt-24 pb-12 px-6">
            {product && (
                <SEO
                    ...
                    image={product.images?.[0] ? (product.images[0].startsWith('http') ? product.images[0] : `http://localhost:5000${product.images[0]}`) : ""}
                />
            )}
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    >
                        <img
                            src={product.images?.[0] ? (product.images[0].startsWith('http') ? product.images[0] : `http://localhost:5000${product.images[0]}`) : "https://via.placeholder.com/600"}
                            alt={product.name}
